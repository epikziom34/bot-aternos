...
const config = {
  host: "krulminecraft.aternos.me", //mc.hypixel.net for example
  port: 25565, //server port (leave it as is unless you know what you're doing!)
  username: "BOT1", //username only for cracked/offline mode servers, email for premium
  //password: "password123", //only for premium
  version: false //version of the server (false = auto detect)
};

const bot = mineflayer.createBot({
  //creates a new bot from the config above
